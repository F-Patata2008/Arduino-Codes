...
const char* ei_classifier_inferencing_categories[] = { "Bacilos G+", "Bacilos g-", "cocos +dipl" };
...
const ei_impulse_t impulse_583372_0 = {
    .project_id = 583372,
    .project_owner = "Felipe Colli",
    .project_name = "Colli2008-project-1",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_583372_0 = ei_impulse_handle_t( &impulse_583372_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_583372_0;
